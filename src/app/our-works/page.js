                            ...
                            <div className="row clearfix">
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-12 news-block">
                                    <div className="news-block-two wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                        <div className="inner-box">
                                            <figure className="image-box"><Link href="/blog-details"><img src="/assets/images/our-works/Mobile-Call Training.jpg" alt="" /></Link></figure>
                                            <div className="lower-content">
                                                <div className="inner">
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-12 news-block">
                                    <div className="news-block-two wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                                        <div className="inner-box">
                                            <figure className="image-box"><Link href="/blog-details"><img src="/assets/images/our-works/Web-Based-Product-Training.jpg" alt="" /></Link></figure>
                                            <div className="lower-content">
                                                <div className="inner">
                                                    {/* <span className="post-date">12 APRIL</span> */}
